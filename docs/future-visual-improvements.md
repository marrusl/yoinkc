...
- **Triage progress indicator** — per-section "Mark reviewed" button, sidebar progress bar, checkmarks. Spec: `docs/specs/implemented/2026-03-17-visual-improvements-design.md` Part A
